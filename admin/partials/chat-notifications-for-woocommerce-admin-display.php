...
<div class="wafwc-plugin-context">
	...
	<div class="wafwc-container">
		...
		<div class="wafwc-body">
			...
			<p>
				<?php
				_e( '<b>You can also check this <a href="https://developers.facebook.com/docs/whatsapp/phone-numbers" target="_blank">link</a> to find check about telephone numbers.</b>', 'wafwc' );
				?>
			</p>
		</div>
	</div>
	...
	<div class="wafwc-container">
		<div class="wafwc-heading">
			<h2>
				<?php
				_e( '2. Select <b>Business</b> as your app type.', 'wafwc' );
				?>
			</h2>
		</div>
		<div class="wafwc-body">
